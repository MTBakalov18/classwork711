package com.example.classwork711;
...
public class Classwork711Application implements CommandLineRunner {
    private Logger logger = LoggerFactory.getLogger(this.getClass());

    @Autowired
    PlayerDao dao;
    public static void main(String[] args) {
        SpringApplication.run(Classwork711Application.class, args);
    }
